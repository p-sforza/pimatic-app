...
=========
 */
var a, action, actionName, actions, api, apis, assert, dataCriteria, device, i, len, messageCriteria, page, ref, t, variableParams, variableResult;
...
apis = [api.framework, api.rules, api.variables, api.plugins, api.database, api.groups, api.pages, api.devices];
...
for (i = 0, len = apis.length; i < len; i++) {
  ...
  for (actionName in ref) {
    ...
    assert(actions[actionName] == null);
