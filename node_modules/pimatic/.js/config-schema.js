      ...
      properties: {
        ...
        authentication: {
          ...
          properties: {
            ...
            secret: {
              description: "Secret string used for cookie signing. Should be kept secret! If it is not set, then a secret string will be generated for you, at first start. The secret string must be at least 32 characters long.",
              secret: true
            },
            loginTime: {
        ...
        httpsServer: {
          ...
          properties: {
            ...
            rootCertFile: {
              description: "The public root certificate file of your own CA if you are using a self signed certificate. This is optional. It's just for the frontend, so that it can provide a link to the the root certificate for easy importing in mobile devices.",
              type: "string",
        ...
        database: {
          ...
          properties: {
            ...
            diskSyncInterval: {
              description: "Interval for writing logged entries to disk. If this value is smaller than the deleteExpiredInterval setting, then the value of this setting is used instead. Should be a multiple of deleteExpiredInterval.",
              type: "string",
              "default": "4h"
            },
            debug: {
        ...
        defaultMaxListeners: {
          description: "The number of listeners which can be registered\nfor any single event (soft limit)",
          type: "number",
          "default": 200
        }
      }
    ...
    pages: {
      ...
      items: {
        ...
        properties: {
          ...
          allowedRoles: {
            description: "The roles allowed for accessing the page. If absent\nroles are granted access.",
            type: "array",
            required: false
          },
          devices: {
        ...
        properties: {
          ...
          permissions: {
            ...
            properties: {
              ...
              rules: {
                description: "Allow to list all rules (read) or edit existing rules (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              variables: {
                description: "Allow to list all variables (read) or edit existing variables (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              messages: {
                description: "Allow to list all messages (read) or delete existing messages (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              events: {
                description: "Allow to list all events (read) or delete existing events (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              devices: {
                description: "Allow to list all devices (read) or edit existing devices (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              groups: {
                description: "Allow to list all groups (read) or edit existing groups (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              users: {
                description: "Allow to list all users (read) or edit existing users (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              plugins: {
                description: "Allow to list all plugins (read) or edit existing plugins (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              updates: {
                description: "Allow to search for updates or additional do updating",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              config: {
                description: "Allow to show the config (read) or edit existing config (write)",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              database: {
                description: "Allow read and or write to the database",
                type: "string",
                "default": "none",
                "enum": ["none", "read", "write"]
              },
              controlDevices: {
                description: "Allow to control devices (switches, buttons, ...)",
                type: "boolean",
                "default": false
              },
              restart: {
                description: "Allow to restart pimatic",
                type: "boolean",
                "default": false
              }
            }
